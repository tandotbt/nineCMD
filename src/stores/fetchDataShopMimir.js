...
export const useFetchDataShopMimirStore = defineStore('fetchDataShopMimirStore', () => {
  ...
  const {
    ...
    { timeout: 15000, immediate: false },
    {
      ...
      onFetchError(ctx) {
        console.log('Lỗi gì đó với shopAllMimir ' + ctx.error)
        ctx.data = []
        return ctx
      }
    }
